...
namespace :repo do
  ...
  task :purgecdn do
    ...
    run %Q{for d in #{repo_path}/*; do purge_base="https://yum.theforeman.org/#{repo_dest}/$(basename $d)"; curl --silent -X PURGE -H 'Fastly-Soft-Purge:1' ${purge_base}/foreman-release.rpm ${purge_base}/foreman-client-release.rpm; done}
