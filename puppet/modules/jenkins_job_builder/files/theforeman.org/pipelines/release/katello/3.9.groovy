                    ...
                    steps {
                        ...
                        withCredentials([string(credentialsId: 'centos-jenkins', variable: 'PASSWORD')]) {
                            runPlaybook(
                                ...
                                inventory: 'localhost',
                                extraVars: ["jenkins_job_name": "foreman-katello-3.9-test", "jenkins_username": "foreman"],
                ...
                stage('Upgrade test') {
                    ...
                    steps {
                        ...
                        withCredentials([string(credentialsId: 'centos-jenkins', variable: 'PASSWORD')]) {
                            runPlaybook(
                                playbook: 'ci/centos.org/ansible/jenkins_job.yml',
                                extraVars: ["jenkins_job_name": "foreman-katello-upgrade-3.9-test", "jenkins_username": "foreman"],
                                sensitiveExtraVars: ["jenkins_password": "${env.PASSWORD}"]
                            )
                        }
                    }
